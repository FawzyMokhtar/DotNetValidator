...
namespace DotNetValidator
{
    public static partial class ValidationUtility
    {
        ...
        public static Validator Max(this Validator model, double maxValue, string errorMessage = null)
        {
            try
            {
        ...
        /// <param name="errorMessage">An optional validation error message</param>
        /// <returns>A Validator</returns>
        public static Validator Max(this Validator model, DateTime maxDateTime,
        ...
        /// <param name="errorMessage">An optional validation error message</param>
        /// <returns>A Validator</returns>
        public static Validator Max(this Validator model, TimeSpan maxTime,
            string errorMessage = null)
        {
            try
            {
